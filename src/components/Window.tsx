...
export const Window = ({ title, onClose, children }: WindowProps) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-40 p-0 sm:p-2">
      <div className="relative bg-secondary win98-border w-full sm:w-[95%] max-w-sm sm:max-w-md md:max-w-2xl h-[100vh] sm:h-[90vh] max-h-[100vh] sm:max-h-[90vh] flex flex-col shadow-2xl min-w-[280px] max-w-full overflow-hidden">
        {/* Title Bar */}
